...
#r "AppleEsportsErp/src/AppleEsportsErp.Infrastructure/bin/Debug/net8.0/AppleEsportsErp.Infrastructure.dll"
#r "AppleEsportsErp/src/AppleEsportsErp.Domain/bin/Debug/net8.0/AppleEsportsErp.Domain.dll"
#r "AppleEsportsErp/src/AppleEsportsErp.Application/bin/Debug/net8.0/AppleEsportsErp.Application.dll"
...
using (var dbContext = new AppDbContext(options))
{
    try
    {
        ...
        if (count1010 > 0)
        {
            Console.WriteLine(">>> STEP 2: Details of ₹1010 transactions (oldest 5)\n");
        ...
        if (count1000 > 0)
        {
            Console.WriteLine(">>> STEP 3: Details of ₹1000 transactions (newest 5)\n");
        ...
        // Step 4: Date analysis relative to fix
        ...
        if (count1010 > 0)
        {
            Console.WriteLine($"✓ {count1010} historical ₹1010 records exist (pre-fix)");
        }
        if (count1000 > 0)
        {
            Console.WriteLine($"✓ {count1000} new ₹1000 records exist (post-fix or verified)");
        }
        Console.WriteLine($"✓ Fix is working: {(count1010 > 0 && count1000 > 0 ? "Mixed data (migration in progress)" : "Consistent data")}");
    }
    catch (Exception ex)
    {
