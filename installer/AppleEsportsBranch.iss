...
; Restarts this PC if AppleEsports.exe ends without going through its own exit - a Task Manager
...
; Same elevation reasoning as the auto-update registration just above - both of these need
